...
class GeneratedDesignerWindow : public TopWindow {
public:
    typedef GeneratedDesignerWindow CLASSNAME;

    GeneratedDesignerWindow()
    {
        InitWindow();
        InitThemeContext();
        BuildControls();
...
private:
    ...
    void BuildControls()
    {
        ...
        header_title_card.SetTitle("Designer").SetSubTitle("").SetContentInset(DPI(4)).SetMediaGap(DPI(9)).SetMediaReserve(DPI(0)).SetMediaMin(DPI(15)).SetMediaAutoFit(false).SetMediaSide(UiAlign::LEFT).SetMediaAlign(UiAlign::CENTER, UiAlign::CENTER).ShowTitleLine(false).SetTextAlign(UiAlign::LEFT, UiAlign::CENTER);
        ...
        version_label.SetIconScaleToContent(true);
