...
- normal controls use `UiShapes` / `UiShapePath`;
...
## VALIDATION / NEXT
1. Gary: route-fix + UiShapePath Debug/Release gate and obsolete supervisor-branch cleanup.
2. If green, mark geometry/shape foundation PASS.
3. Investigate zoomed-out 10k idle continuous repaint before further Graph work.
